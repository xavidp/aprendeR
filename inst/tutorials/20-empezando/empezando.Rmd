...
Hay dos tipos de respuestas para las preguntas del tutorial: texto y código. Con las respuestas en texto (prosa), usarás el botón "Enviar respuesta", como lo hiziste con tu nombre y correo electrónico. Con las respuestas de código, usa el botón "Ejecutar código", como lo hiziste para esta pregunta.
...
Haz clic en "Terminate jobs". Vuelve a abrir este tutorial. El progreso del tutorial se habrá guardado automáticamente.
...
Ejecuta este comando en la Consola: `options("pkgType")`. CP/CR.
...
Copia y pega todo, desde el "Ejercicio 9" hasta el final de esta frase, en el cuadro de respuesta a continuación.
...
Después de pulsar el botón "Descargar", se te pedirá que guardes un archivo llamado `getting-started_answers` o `empezando_answers` con un sufijo que depende del botón que hayas seleccionado. Puede descargar tus respuestas como archivos `rds`, `html` o `pdf`. Este archivo se guardará en la carpeta Descargas predeterminada de tu ordenador, incluso si completaste el tutorial en una plataforma de computación en la nube. Si lo deseas, puedes descargar varios formatos.
...
*¡Felicidades!* Ahora comprendes cómo funcionan los tutoriales y cómo descargar copias de tus respuestas.
