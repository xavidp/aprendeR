...
Para confirmar que has ejecutado este comando, ejecuta `rstudioapi::readRStudioPreference(name = "load_workspace", default = "Code failed.")` desde la Consola de R. PC/CR.
...
Ejecuta este comando en la Consola: `options("pkgType")`. PC/CR.
...
Ahora comprendes cómo funcionan los tutoriales y cómo descargar copias de tus respuestas.
