...
Puedes abrir una página de ayuda para cualquier objeto que venga con R o con un paquete R. Para abrir la página de ayuda, escribe un `?` antes del nombre del objeto y luego ejecuta el comando, como lo hiciste con `?millas`. Esta técnica funciona para funciones, paquetes y en más casos.
